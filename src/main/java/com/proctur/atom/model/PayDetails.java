...
public class PayDetails {
	...
	public String toString() {
		return "PayDetails [prodDetails=" + prodDetails + ", amount=" + amount + ", surchargeAmount=" + surchargeAmount
				...
				+ ", getTotalRefundAmount()=" + getTotalRefundAmount() + ", getProdDetails()=" + getProdDetails()
